...
public final class LBClient extends
    ...
    public RibbonResponse execute(RibbonRequest request, IClientConfig configOverride)
        ...
        if (configOverride != null) {
            ...
            options = new Request.Options(connectTimeout, readTimeout, true);
        }
    ...
    protected void customizeLoadBalancerCommandBuilder(RibbonRequest request, IClientConfig config, LoadBalancerCommand.Builder<RibbonResponse> builder) {
        ...
        //JSONObject jsonObj = JSONObject.parser(request.request.requestBody().asString());
        builder.withServerLocator(request.request);
        System.out.println("!!!customizeLoadBalancerCommandBuilder!!!");
    }
}
